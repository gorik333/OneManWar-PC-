...
public class FirstLvlPlayerShootMechanic : MonoBehaviour
{
    ...
    private FirstLvlPlayerSwitchAmmoType _switchAmmoType;
    ...
    void Start()
    {
        _switchAmmoType = GetComponent<FirstLvlPlayerSwitchAmmoType>();
    ...
    {
        GameObject currentBullet = Instantiate(_commonBullet, _firePoint.position, spread); // ТУТ ВСЕ РАБОТАЕТ, ТОЛЬКО НАСТРОИТЬ ОСТАЛОСЬ
        ...
        var currentBulletDamage = currentBullet.GetComponent<FirstLvlPlayerCommonBulletMechanic>();
    ...
    {
        GameObject currentBullet = Instantiate(_strengthenedBullet, _firePoint.position, spread); // ТУТ ВСЕ РАБОТАЕТ, ТОЛЬКО НАСТРОИТЬ ОСТАЛОСЬ
        ...
        var currentBulletProperties = currentBullet.GetComponent<FirstLvlPlayerStrengthenedBulletMechanic>();
    ...
    private void CommonBulletsReload()
    {
        StartReloading();
    ...
    private void StrengthenedBulletsReload()
    {
        StartReloading();
        StartCoroutine(ReloadDelay());
